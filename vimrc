" This is based on miguelgrinberg's vimrc found at
"  https://gist.github.com/miguelgrinberg/527bb5a400791f89b3c4da4bd61222e4
"
" Uses vim-plug (https://github.com/junegunn/vim-plug)
" For tutorial, see https://github.com/junegunn/vim-plug/wiki/tutorial
...
"  \      "lsp-settings": 'https://github.com/mattn/vim-lsp-settings.git',
...
"  \          "vim-wiki": 'https://github.com/vimwiki/vimwiki.git',
"  \ }
"
"call plug#begin('~/.vim/plugged')
"for s:pname in keys(s:plugin_list)
"   :call g:plug#(s:plugin_list[s:pname])
"endfor
...
let s:conf_files = [
 \      'map-vim-easy-align.vim',
 \      'config-airline-themes.vim',
 \      'config-airline.vim',
 \                 ]

for s:fname in s:conf_files
  execute printf('source ~/.config/vim/%s', s:fname)
endfor
...
" Airline
let g:airline_powerline_fonts = 1  " used by airline
